...
_G.packer_plugins = {
  ...
  ["color-picker.nvim"] = {
    ...
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/color-picker.nvim",
  ...
  ["live-server.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/opt/live-server.nvim",
  ...
  ["mason-update-all"] = {
    ...
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/mason-update-all",
  ...
  vimwiki = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/vimwiki",
